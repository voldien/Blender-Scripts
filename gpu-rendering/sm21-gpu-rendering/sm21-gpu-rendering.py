...
if __name__ == "__main__":
    # Override the default gcc compiler and remove warning for Nvidia CUDA that are in the depreciation list.
    environ['CYCLES_CUDA_EXTRA_CFLAGS'] = "-ccbin gcc-4.8 -Wno-deprecated-gpu-targets"

    # Create parser object.
    parser, args = create_cycle_gpu_parser(sys.argv)
    # Perform rendering.
